...
class RelationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create relation" do
    assert_difference('Relation.count') do
      post relations_url, params: { relation: { friend_id: @relation.friend_id, user_id: @relation.user_id } }
    end
  ...
  test "should update relation" do
    patch relation_url(@relation), params: { relation: { friend_id: @relation.friend_id, user_id: @relation.user_id } }
